...
const RegisterComp = () => {
  ...
  const handleInputChangeForPhoneNum = (e) => {
  ...
  return (
    <>
      <div className="bg-colorbase shadow-2xl rounded-xl px-12 py-16 max-w-[900px] w-full border">
        <h1 className="text-4xl text-primary poppins-bold mb-6">
          Daftarkan akun
        </h1>
        <form onSubmit={handleRegister}>
          <div className="w-full grid grid-rows-3 grid-cols-2 grid-flow-col gap-x-4">
            {/* First Name Input */}
            <div className="mb-4">
              <label htmlFor="first_name" className="label-input">
                Nama Depan
              </label>
              <input
                required
            ...
            {/* Last Name Input */}
            <div className="mb-4">
              <label htmlFor="last_name" className="label-input">
                Nama Belakang
              </label>
              <input
                required
            ...
            {/* Phone Number Input */}
            <div className="mb-4">
              <label htmlFor="phone_number" className="label-input">
                Nomor Telepon
              </label>
              <input
                required
                ...
                className="input-gray pr-10"
                placeholder="Ketik di sini"
                onChange={handleInputChangeForPhoneNum}
                value={phoneNum}
              />
            </div>
