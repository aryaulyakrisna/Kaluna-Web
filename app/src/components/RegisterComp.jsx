...
const RegisterComp = () => {
  ...
  return (
    <div className="bg-colorbase shadow-2xl rounded-xl px-12 py-16 max-w-[800px] w-full border">
      <h1 className="text-4xl text-primary poppins-bold mb-6">
        Daftarkan akun
      </h1>
      <form>
        <div className="w-full grid md:grid-rows-3 grid-flow-col gap-x-4">
          {/* First Name Input */}
          <div className="mb-4">
          ...
          {/* Phone Number Input */}
          <div className="mb-4">
            <label htmlFor="phone_num" className="label-input">
              Nomor Telepon
            </label>
            <input
              required
